...
whatsapp_cfg: Dict = config.get("pacientes", {})
...
wa_greeting: str = excel_cfg.get("saludo", default_config["pacientes"]["saludo"])
wa_end_greeting: str = excel_cfg.get(
    "final_saludo", default_config["pacientes"]["final_saludo"]
)
wa_text: str = excel_cfg.get("text", default_config["pacientes"]["texto"])
